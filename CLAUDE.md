...
Single-file MCP server (`src/index.ts`, ~470 lines) that bridges AI assistants with arXiv. Published as `@yqy1277/arxiv-paper-mcp` on npm. Communicates via stdio transport.
